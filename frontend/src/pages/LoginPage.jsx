...
export default function LoginPage() {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '75vh', position: 'relative' }}>
      ...
      {/* Background ambient glow blur spot */}
      <div className="ambient-glow-login"></div>

      <div className="glass-card" style={{ maxWidth: '480px', width: '100%', padding: 0, position: 'relative', overflow: 'hidden', zIndex: 1 }}>
        <div className="window-header">
          ...
          <h4 className="window-title" style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: 'var(--primary)', margin: 0 }}>
            <Shield size={14} />
